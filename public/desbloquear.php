...
if($user){
    ...
    $mensaje = "El enlace no es valido o ya expiro.";
    $color   = "#dc2626";
}
?>
<!DOCTYPE html>
...
<div class="card" style="text-align:center;">
    <p style="font-size:16px; margin-bottom:20px; color:<?php echo $color; ?>">
        <?php echo htmlspecialchars($mensaje); ?>
    </p>
    <a href="/login.php" style="color:#4f46e5; font-weight:600;">Ir al inicio de sesion →</a>
</div>
</body>
</html>

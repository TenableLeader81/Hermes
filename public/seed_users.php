...
foreach ($usuarios as $u) {
    ...
    $stmt = $conn->prepare("
        INSERT IGNORE INTO usuarios (nombre, apellido_paterno, apellido_materno, correo, matricula, password_hash, rol, twofa_enabled)
        VALUES (:nombre, :ap, :am, :correo, :matricula, :hash, :rol, 1)
    ");
    $stmt->execute([
        ':nombre'    => $u['nombre'],
...
echo "<h2 style='font-family:sans-serif;color:green'>✅ Usuarios de prueba creados</h2>";
...
echo "</table>";
echo "<p style='font-family:sans-serif'><strong>Elimina este archivo después de usarlo.</strong></p>";
?>

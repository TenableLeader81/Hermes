-- ══════════════════════════════════════════════════════
--  HERMES — Esquema completo actualizado
...
-- Base de datos
CREATE DATABASE IF NOT EXISTS `dbhermes`
...
--  Contraseña: admin123  (cámbiala después de importar)
-- ──────────────────────────────────────────────────────
INSERT INTO `usuarios` (`nombre`, `correo`, `password_hash`, `matricula`, `rol`)
VALUES (
  'Administrador',
  'admin@uteq.edu.mx',
